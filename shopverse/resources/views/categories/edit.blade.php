<x-layout title="ShopVerse - Edit Kategori">
    <div class="py-12 bg-slate-950">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-extrabold text-white tracking-tight">Edit Kategori</h1>
                    <p class="text-slate-400 text-sm mt-1">Ubah nama kategori produk #{{ $category->id }}.</p>
                </div>
            ...
            <div class="bg-slate-900 border border-slate-800 rounded-2xl p-6 sm:p-8 shadow-xl">
                <form action="{{ route('categories.update', $category->id) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $category->name) }}" placeholder="Contoh: Elektronik, Fashion, Audio..." required
